    ...
    return new Promise((resolve) => {
      axios
        ...
        .then(({ data }) => {
          ...
          setStatus(
            confirmation ||
              'Thanks for your feedback, it will be used to inform future updates.'
          )
        })
        .catch(({ err }) => {
          resolve()
      ...
      <Box p="1" pt="3">
        <form onSubmit={handleSubmit(onSubmit)}>
          <Box textAlign="center" px="5">
            <Text fontSize="sm" color="gray.500" mb="4" pr="4">
...
export { RatingFeedback, TextFeedback, NPSFeedback }
